  ...
  <head>
    ...
    jQuery(function($){
		$('#userTable').datagrid({
			...
			url:"scheduler/listall.do", //数据来源
			sortName: 'schduler.id', //排序的列
			sortOrder: 'desc', //倒序
			...
			columns:[[
				...
				{field:'user.host',title:'年龄',width:20,sortable:true,
					formatter:function(value,row,index){return row.user.age;}
				},
				{field:'user.port',title:'生日',width:30,sortable:true,
